...
import { findEditableInputIndex } from "../utils/editableInputNavigation.js";
...
export function DictationPage() {
  ...
  const focusAdjacentWord = useCallback((fromIndex, direction, caretPosition) => {
    const targetIndex = findEditableInputIndex(inputRefs.current, fromIndex, direction);
    if (targetIndex === -1) return false;
    focusWord(targetIndex, caretPosition);
    return true;
  }, [focusWord]);
