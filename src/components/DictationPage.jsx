...
export function DictationPage() {
  ...
  function handlePracticeKeyDown(event) {
    if (event.key === "Tab") { event.preventDefault(); replayCurrentSentence(); }
    else if (event.key === "Escape") { event.preventDefault(); stopPlayback(); }
  }
